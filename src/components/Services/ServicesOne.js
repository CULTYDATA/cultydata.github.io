  ...
  return (
    <>
          ...
          <section className="solutions-area pt-100 pb-70">
            ...
            <h2>Cutting-Edge Technology Services</h2>
          </div>
              ...
              <div className="row">
                <div className="col-lg-4 col-md-6 col-sm-6">
                  <div className="single-solutions-box">
                    ...
                    <p>
                      We design and develop custom blockchain solutions,
                      including tokenized asset platforms, DApps, and seamless
                ...
                <div className="col-lg-4 col-md-6 col-sm-6">
                  <div className="single-solutions-box">
                    ...
                    <p>
                      We provide end-to-end development services for Web2 and
                      Web3 platforms, covering front-end and back-end
