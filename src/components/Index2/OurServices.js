          ...
          <div className="row justify-content-center">
            <div className="col-lg-5 col-md-6 col-sm-12">
              <div className="single-services-box-item">
                ...
                <h3>
                  <Link to="/services/service-details">Tailored Digital Platform Development</Link>
                </h3>
                <p>
            ...
            <div className="col-lg-5   col-md-6 col-sm-12">
              <div className="single-services-box-item">
                ...
                <h3>
                  <Link to="/services/service-details"> Tech Team Building & Training</Link>
                </h3>
                <p>
            ...
            <div className="col-lg-5 col-md-6 col-sm-12">
              <div className="single-services-box-item">
                ...
                <h3>
                  <Link to="/services/service-details">Cloud-Native Architecture Design</Link>
                </h3>
                <p>
            ...
            <div className="col-lg-5 col-md-6 col-sm-12">
              <div className="single-services-box-item">
                ...
                <h3>
                  <Link to="/services/service-details">Continuous Delivery Pipeline Setup</Link>
                </h3>
                <p>
